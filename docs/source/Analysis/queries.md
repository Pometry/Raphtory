...
To run your implemented algorithm or any of the algorithms included in Raphtory ([See here](com.raphtory.algorithms)), you must submit them to the graph. We can again use the [Lord of the Rings
