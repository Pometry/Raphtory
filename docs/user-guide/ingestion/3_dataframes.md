...
assert str(g) == "Graph(number_of_nodes=5, number_of_edges=7, number_of_temporal_edges=7, earliest_time=EventTime(t=1693555200000, dt=2023-09-01T08:00:00+00:00, event_id=0), latest_time=EventTime(t=1693557000000, dt=2023-09-01T08:30:00+00:00, event_id=12))"
```
...
!!! Output
    ...
    Graph(number_of_nodes=5, number_of_edges=7, number_of_temporal_edges=7, earliest_time=EventTime(t=1693555200000, dt=2023-09-01T08:00:00+00:00, event_id=0), latest_time=EventTime(t=1693557000000, dt=2023-09-01T08:30:00+00:00, event_id=12))
    Node(name=ServerA, earliest_time=EventTime(t=1693555200000, dt=2023-09-01T08:00:00+00:00, event_id=0), latest_time=EventTime(t=1693556400000, dt=2023-09-01T08:20:00+00:00, event_id=4), properties=Properties({OS_version: Ubuntu 20.04, primary_function: Database, uptime_days: 120}))
    Edge(source=ServerA, target=ServerB, earliest_time=EventTime(t=1693555200000, dt=2023-09-01T08:00:00+00:00, event_id=0), latest_time=EventTime(t=1693555200000, dt=2023-09-01T08:00:00+00:00, event_id=0), properties={data_size_MB: 5.6}, layer(s)=[Critical System Request])
    ```
...
assert str(h) == "Graph(number_of_nodes=5, number_of_edges=7, number_of_temporal_edges=7, earliest_time=EventTime(t=1693555200000, dt=2023-09-01T08:00:00+00:00, event_id=0), latest_time=EventTime(t=1693557000000, dt=2023-09-01T08:30:00+00:00, event_id=12))"
```
