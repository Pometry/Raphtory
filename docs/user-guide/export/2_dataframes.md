...
assert str(grunting_graph) == "Graph(number_of_nodes=2, number_of_edges=2, number_of_temporal_edges=6, earliest_time=EventTime[1560526320000, 365], latest_time=EventTime[1562253540000, 2531])"
assert str(grunting_graph.edges) == "Edges(Edge(source=ANGELE, target=FELIPE, earliest_time=EventTime[1560526320000, 365], latest_time=EventTime[1561042620000, 871], properties={Weight: 1}, layer(s)=[Grunting-Lipsmacking]), Edge(source=FELIPE, target=ANGELE, earliest_time=EventTime[1560526320000, 366], latest_time=EventTime[1562253540000, 2531], properties={Weight: 1}, layer(s)=[Grunting-Lipsmacking]))"
```
...
!!! Output
    ...
    Graph(number_of_nodes=2, number_of_edges=2, number_of_temporal_edges=6, earliest_time=EventTime[1560526320000, 365], latest_time=EventTime[1562253540000, 2531])
    Edges(Edge(source=ANGELE, target=FELIPE, earliest_time=EventTime[1560526320000, 365], latest_time=EventTime[1561042620000, 871], properties={Weight: 1}, layer(s)=[Grunting-Lipsmacking]), Edge(source=FELIPE, target=ANGELE, earliest_time=EventTime[1560526320000, 366], latest_time=EventTime[1562253540000, 2531], properties={Weight: 1}, layer(s)=[Grunting-Lipsmacking]))
