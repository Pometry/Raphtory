...
assert str(G.edges.explode()) == "Edges(Edge(source=Alice, target=Bob, earliest_time=EventTime(t=1, dt=1970-01-01T00:00:00.001+00:00, event_id=0), latest_time=EventTime(t=3, dt=1970-01-01T00:00:00.003+00:00, event_id=2), layer(s)=[_default]), Edge(source=Alice, target=Bob, earliest_time=EventTime(t=3, dt=1970-01-01T00:00:00.003+00:00, event_id=2), latest_time=EventTime(t=5, dt=1970-01-01T00:00:00.005+00:00, event_id=1), layer(s)=[_default]))"
```
...
!!! Output
    ...
    ```output
    Edges(Edge(source=Alice, target=Bob, earliest_time=EventTime(t=1, dt=1970-01-01T00:00:00.001+00:00, event_id=0), latest_time=EventTime(t=3, dt=1970-01-01T00:00:00.003+00:00, event_id=2), layer(s)=[_default]), Edge(source=Alice, target=Bob, earliest_time=EventTime(t=3, dt=1970-01-01T00:00:00.003+00:00, event_id=2), latest_time=EventTime(t=5, dt=1970-01-01T00:00:00.005+00:00, event_id=1), layer(s)=[_default]))
    ```
...
```{.python continuation hide}
assert str(f"G's edges are {G.edges.explode()}") == "G's edges are Edges(Edge(source=Alice, target=Bob, earliest_time=EventTime(t=1, dt=1970-01-01T00:00:00.001+00:00, event_id=1), latest_time=EventTime(t=5, dt=1970-01-01T00:00:00.005+00:00, event_id=0), layer(s)=[_default]))"
```
...
!!! Output
    ...
    ```output
    G's edges are Edges()
    G's edges are Edges(Edge(source=Alice, target=Bob, earliest_time=EventTime(t=1, dt=1970-01-01T00:00:00.001+00:00, event_id=1), latest_time=EventTime(t=5, dt=1970-01-01T00:00:00.005+00:00, event_id=0), layer(s)=[_default]))
    ```
...
```{.python continuation hide}
assert str(f"G1's edges are {G1.edges.explode()}") == "G1's edges are Edges(Edge(source=1, target=2, earliest_time=EventTime(t=1, dt=1970-01-01T00:00:00.001+00:00, event_id=0), latest_time=EventTime(t=1, dt=1970-01-01T00:00:00.001+00:00, event_id=1), properties={message: hi}, layer(s)=[_default]))"
```

!!! Output

    ```output
    G1's edges are Edges(Edge(source=1, target=2, earliest_time=EventTime(t=1, dt=1970-01-01T00:00:00.001+00:00, event_id=0), latest_time=EventTime(t=1, dt=1970-01-01T00:00:00.001+00:00, event_id=1), properties={message: hi}, layer(s)=[_default]))
    ```
...
```{.python continuation hide}
assert str(G.edges.explode()) == "Edges(Edge(source=Alice, target=Bob, earliest_time=EventTime(t=1, dt=1970-01-01T00:00:00.001+00:00, event_id=0), latest_time=EventTime(t=5, dt=1970-01-01T00:00:00.005+00:00, event_id=1), layer(s)=[colleagues]), Edge(source=Alice, target=Bob, earliest_time=EventTime(t=3, dt=1970-01-01T00:00:00.003+00:00, event_id=2), latest_time=EventTime(t=7, dt=1970-01-01T00:00:00.007+00:00, event_id=3), layer(s)=[friends]))"
```

!!! Output

```output
Edges(Edge(source=Alice, target=Bob, earliest_time=EventTime(t=1, dt=1970-01-01T00:00:00.001+00:00, event_id=0), latest_time=EventTime(t=5, dt=1970-01-01T00:00:00.005+00:00, event_id=1), layer(s)=[colleagues]), Edge(source=Alice, target=Bob, earliest_time=EventTime(t=3, dt=1970-01-01T00:00:00.003+00:00, event_id=2), latest_time=EventTime(t=7, dt=1970-01-01T00:00:00.007+00:00, event_id=3), layer(s)=[friends]))
```
