...
class GenericGraphPerspective(query: Query, private val querySender: QuerySender)
  ...
  override type G  = GenericGraphPerspective
  override type MG = MultilayerGraphPerspective
  override type RG = GenericGraphPerspective
...
class GenericMultilayerGraphPerspective(query: Query, private val querySender: QuerySender)
        extends DefaultGraphOperations(query, querySender)
        with MultilayerGraphPerspective {
  override type G  = GenericMultilayerGraphPerspective
  override type MG = GenericMultilayerGraphPerspective
  override type RG = GenericGraphPerspective
