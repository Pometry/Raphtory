package com.raphtory.internal.components.querymanager
...
import com.raphtory.internal.graph.PerspectiveController.DEFAULT_PERSPECTIVE_TIME
import com.raphtory.internal.graph.PerspectiveController.DEFAULT_PERSPECTIVE_WINDOW
