...
function checkResponse<RT extends "binary" | "none" | "text" | undefined>(
  ...
  const result = check(response, {
    ...
    "response has data field defined": (r) => {
      if (typeof r.body === "string") {
        ...
        const result =
          "data" in body && body.data !== undefined && body.data !== null; // FIXME: improve query checking, I wish I could just rely on genql
