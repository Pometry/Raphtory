...
impl IllegalSet {
    pub fn new<A: Debug>(index: usize, previous_value: &A, new_value: &A) -> IllegalSet {
        IllegalSet {
            index,
            previous_value: format!("{:?}", previous_value),
