...
class GraphView(object): 
    ...
    def vectorise(self, embedding: Callable[[list], list], nodes: bool | str = True, edges: bool | str = True, verbose: bool = False) -> VectorisedGraph:
        """
