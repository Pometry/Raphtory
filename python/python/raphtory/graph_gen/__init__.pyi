...
def random_attachment(g: Graph, nodes_to_add: int, edges_per_step: int, seed: Optional[list[int]] = None) -> None:
    """
...
def ba_preferential_attachment(g: Graph, nodes_to_add: int, edges_per_step: int, seed: Optional[list[int]] = None) -> None:
    """
