...
def pagerank(graph: GraphView, iter_count: int = 20, max_diff: Optional[float] = None, use_l2_norm: bool = True, damping_factor: float = 0.85, weight: Optional[str] = None) -> OutputNodeState:
    """
...
def local_clustering_coefficient_batch(graph: GraphView, v: Optional[list[NodeInput]] = None) -> OutputNodeState:
    """
...
def louvain(graph: GraphView, resolution: float = 1.0, weight_prop: str | None = None, tol: None | float = None, rng_seed: int | None = None) -> NodeStateUsize:
    """
