...
__all__ = ['GraphServer', 'RunningGraphServer', 'RaphtoryClient', 'RemoteGraph', 'RemoteEdge', 'RemoteNode', 'RemoteNodeAddition', 'RemoteUpdate', 'RemoteEdgeAddition', 'encode_graph', 'decode_graph']
...
class RemoteEdge(object): 
    ...
    def add_constant_properties(self, properties: Dict[str, Prop], layer: Optional[str] = None) -> None:
        """
    ...
    def add_updates(self, t: int | str | datetime, properties: Optional[Dict[str, Prop]] = None, layer: Optional[str] = None) -> None:
        """
    ...
    def update_constant_properties(self, properties: Dict[str, Prop], layer: Optional[str] = None) -> None:
        """
...
class RemoteNode(object): 
    ...
    def add_updates(self, t: int | str | datetime, properties: Optional[Dict[str, Prop]] = None) -> None:
        """
...
class RemoteNodeAddition(object): 
    ...
    def __new__(cls, name: GID, node_type: Optional[str] = None, constant_properties: Optional[PropInput] = None, updates: Any = None) -> RemoteNodeAddition:
        """Create and return a new object.  See help(type) for accurate signature."""
...
class RemoteEdgeAddition(object): 
    ...
    def __new__(cls, src: GID, dst: GID, layer: Optional[str] = None, constant_properties: Optional[PropInput] = None, updates: Optional[list[RemoteUpdate]] = None) -> RemoteEdgeAddition:
        """Create and return a new object.  See help(type) for accurate signature."""
