...
class RemoteEdge:
    ...
    def add_updates(self, /, t: int | str | datetime.datetime, properties: Optional[Dict[str, Prop]] = None, layer: Optional[str] = None):
        """
    ...
    def delete(self, /, t: int | str | datetime.datetime, layer: Optional[str] = None):
        """
