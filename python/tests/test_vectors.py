...
def create_graph() -> VectorizedGraph:
    ...
    v = VectorizedGraph.build(g, embedding, node_document="doc", edge_document="doc")
...
#     assert(len(v.get_documents()) == 0)
#     assert(len(v.get_documents_with_scores()) == 0)
...
#     selection = v.expand_with_search("node3", 10)
