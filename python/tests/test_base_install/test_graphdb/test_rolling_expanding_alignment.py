...
def test_rolling_alignment_smallest_of_window_and_step(example_graph):
    ...
    assert windows[1].start_date_time == datetime(2025, 2, 17, 0, 0, 0, 0, tzinfo=timezone.utc)
    assert windows[1].end_date_time == datetime(2025, 3, 17, 0, 0, 0, 0, tzinfo=timezone.utc)
    assert windows[2].start_date_time == datetime(2025, 2, 18, 0, 0, 0, 0, tzinfo=timezone.utc)
    assert windows[2].end_date_time == datetime(2025, 3, 18, 0, 0, 0, 0, tzinfo=timezone.utc)
...
def test_node_rolling_alignment(example_graph_with_edges):
    ...
    assert windows[0].start_date_time == datetime(2025, 3, 15, 0, 0, tzinfo=timezone.utc)
    assert windows[0].end_date_time   == datetime(2025, 3, 16, 0, 0, tzinfo=timezone.utc)
    assert windows[1].start_date_time == datetime(2025, 3, 16, 0, 0, tzinfo=timezone.utc)
    assert windows[1].end_date_time   == datetime(2025, 3, 17, 0, 0, tzinfo=timezone.utc)

    exp_windows = list(islice(n1.expanding("1 day"), 2))
    assert exp_windows[0].end_date_time == datetime(2025, 3, 16, 0, 0, tzinfo=timezone.utc)
    assert exp_windows[1].end_date_time == datetime(2025, 3, 17, 0, 0, tzinfo=timezone.utc)
...
def test_window_3weeks_2days(example_graph_with_edges):
    ...
    assert windows[1].start_date_time == datetime(2025, 2, 26, 0, 0, tzinfo=timezone.utc)
    assert windows[1].end_date_time == datetime(2025, 3, 19, 0, 0, tzinfo=timezone.utc)
    assert windows[2].start_date_time == datetime(2025, 2, 28, 0, 0, tzinfo=timezone.utc)
