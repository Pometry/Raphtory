...
def test_algo_result():
    ...
    expected = {
        "3": 0.1027408093214035,
        "2": 0.1027408093214035,
        "4": 0.16152982413768768,
        "6": 0.1407477855682373,
        "1": 0.0720985010266304,
        "5": 0.16152982413768768,
        "7": 0.1407477855682373,
        "8": 0.1178646832704544,
    }
    ...
    for i in expected.keys():
        print(actual[i]["reachable_nodes"])
...
def test_degree_centrality():
    ...
    print(actual["1"] == {"degree_centrality": 1.0})
    expected = {
