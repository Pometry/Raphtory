...
object Dependencies {
  ...
  lazy val gson              = "com.google.code.gson"         % "gson"                            % gsonVersion excludeAll (excludeLog4j, excludeSlf4j)
  ...
  lazy val openhft           = "net.openhft"                  % "zero-allocation-hashing"         % openhftVersion excludeAll (excludeLog4j, excludeSlf4j)
  ...
  lazy val pulsarAdmin       = "org.apache.pulsar"            % "pulsar-client-admin-original"    % pulsarVersion excludeAll excludePulsarBinding
  ...
  lazy val timeSeries        = "io.sqooba.oss"               %% "scala-timeseries-lib"            % timeSeriesVersion excludeAll (excludeLog4j, excludeSlf4j)
