...
#[pyo3(signature = (g, seeds, infection_prob, initial_infection, recovery_rate=None, incubation_rate=None, rng_seed=None))]
...
#[pyfunction]
#[pyo3[signature=(g, resolution=1.0, weight_prop=None, tol=None)]]
pub fn louvain(
    g: &PyGraphView,
    resolution: f64,
    ...
    louvain_rs::<ModularityUnDir, _>(&g.graph, resolution, weight_prop, tol)
}
...
///
#[pyfunction]
#[pyo3[signature=(g, iter_count=100, scale=1.0, node_start_size=1.0, cooloff_factor=0.95, dt=0.1)]]
...
#[pyfunction]
#[pyo3[signature = (g, views, k, delta)]]
pub fn temporal_rich_club_coefficient(
    ...
    Ok(temporal_rich_club_rs(&g.graph, views, k, delta))
}
...
#[pyfunction]
#[pyo3(signature = (g, weight_prop=None, max_cardinality=true, verify_optimum_flag=false))]
pub fn max_weight_matching(
    ...
    mwm(&g.graph, weight_prop, max_cardinality, verify_optimum_flag)
}
