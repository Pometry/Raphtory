    ...
    G: StaticGraphViewOps,
{
    ...
    let step2 = ATask::new(move |vv: &mut EvalNodeView<G, FastRPState>| {
        ...
        let weights = Arc::clone(&weights);
        let denom: f64 = weights[vv.graph().ss.clone()] / ((vv.neighbours().iter().count() * (num_iters+1)) as f64);
...
mod fast_rp_test {
    ...
    fn simple_fast_rp_test() {
        ...
        let baseline: HashMap<String, Vec<f64>> = HashMap::from([
            (String::from("4"), vec![0.0, 1.9620916355920008, -1.6817928305074292, -1.6817928305074292, 0.2802988050845715, -0.2802988050845715, 0.2802988050845715, 1.4014940254228576, -0.2802988050845715, 0.0, 0.0, -1.6817928305074292, 0.2802988050845715, 0.2802988050845715, -0.2802988050845715, 1.121195220338286]), 
            (String::from("0"), vec![
                1.6817928305074292, 
                0.4204482076268573, 
                -0.4204482076268573, 
            ...
            (String::from("6"), vec![1.4014940254228576, 1.9620916355920008, -0.2802988050845715, 1.121195220338286, 0.2802988050845715, -0.2802988050845715, 1.6817928305074292, 0.0, -0.2802988050845715, 0.0, 0.0, -0.2802988050845715, 0.2802988050845715, 1.6817928305074292, -1.6817928305074292, -1.6817928305074292]), 
            (String::from("1"), vec![
                0.4204482076268573, 
                1.6817928305074292, 
                -1.6817928305074292, 
