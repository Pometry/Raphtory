...
pub const NODE_GID_COL: &str = "rap_node_gid";
pub const NODE_VID_COL: &str = "rap_node_vid";
pub const TYPE_COL: &str = "rap_node_type";
pub const TYPE_ID_COL: &str = "rap_node_type_id";
pub const TIME_COL: &str = "rap_time";
pub const SECONDARY_INDEX_COL: &str = "rap_secondary_index";
pub const SRC_VID_COL: &str = "rap_src_vid";
pub const DST_VID_COL: &str = "rap_dst_vid";
pub const SRC_GID_COL: &str = "rap_src_gid";
pub const DST_GID_COL: &str = "rap_dst_gid";
pub const EDGE_COL_ID: &str = "rap_edge_id";
pub const LAYER_COL: &str = "rap_layer";
pub const LAYER_ID_COL: &str = "rap_layer_id";
