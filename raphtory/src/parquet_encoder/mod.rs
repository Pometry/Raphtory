...
pub(crate) const SRC_COL_VID: &str = "rap_src_id";
pub(crate) const DST_COL_VID: &str = "rap_dst_id";
pub(crate) const SRC_COL_ID: &str = "rap_src_gid";
pub(crate) const DST_COL_ID: &str = "rap_dst_gid";
