...
use crate::{
    ...
    db::{
        api::{
            ...
            view::{
                internal::{BaseFilter, EdgeTimeSemanticsOps, GraphView, Static},
...
impl<'graph, G: GraphViewOps<'graph>> ConstantPropertiesOps for EdgeView<G> {
...
impl<G: GraphView> TemporalPropertyViewOps for EdgeView<G> {
