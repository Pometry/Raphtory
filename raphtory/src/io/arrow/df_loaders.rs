...
mod tests {
    use crate::{
        ...
        prelude::*,
        test_utils::{build_edge_list, build_layered_edge_list},
    };
    ...
    #[test]
    fn layers_test_load_edges() {
        proptest!(|(edges in build_layered_edge_list(1000, 100, 12), chunk_size in 1usize..=1000)| {
           check_load_edges_layers(edges, chunk_size);
        })
    }
