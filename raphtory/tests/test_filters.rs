...
mod test {
    ...
    mod test_property_semantics {
        ...
        mod test_node_property_filter_semantics {
            use crate::test::IdentityGraphTransformer;
            use raphtory::{
                db::{
    ...
    mod test_node_property_filter {
        use crate::test::{init_nodes_graph, IdentityGraphTransformer};
    ...
    mod test_node_composite_filter {
        ...
        use crate::test::{init_edges_graph, init_nodes_graph, IdentityGraphTransformer};
        use raphtory::{
            db::graph::{
                assertions::{
                ...
                graph::{
                    ...
                    views::filter::{
                        model::{
                            node_filter::NodeFilter,
                            property_filter::ops::{
                                ElemQualifierOps, ListAggOps, PropertyFilterOps,
                            },
                            PropertyFilterFactory, TemporalPropertyFilterFactory,
    ...
    mod test_edge_filter {
        ...
        use raphtory::db::graph::{
            assertions::{
                assert_filter_edges_results, assert_search_edges_results,
                assert_select_edges_results, TestGraphVariants, TestVariants,
            },
            views::filter::model::{
    ...
    mod test_edge_property_filter {
        use crate::test::{init_edges_graph, init_edges_graph2, IdentityGraphTransformer};
        use raphtory::db::graph::{
            assertions::{
    ...
    mod test_edge_composite_filter {
        use crate::test::{init_edges_graph, IdentityGraphTransformer};
        use raphtory::db::graph::{
            assertions::{
                assert_filter_edges_results, assert_search_edges_results, TestGraphVariants,
                TestVariants,
