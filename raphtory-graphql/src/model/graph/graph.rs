        ...
        for view in views {
            ...
            match view {
                ...
                SnapshotAt(snapshot_at) => {
                    return_view = return_view.snapshot_at(snapshot_at).await;
                }
                Before(before) => {
