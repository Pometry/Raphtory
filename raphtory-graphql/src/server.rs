...
impl RaphtoryServer {
    ...
    pub fn start_with_port(self, port: u16, log_config_or_level: &str,enable_tracing:bool) -> RunningRaphtoryServer {
    ...
    pub async fn run_with_port(self, port: u16, log_config_or_level: &str,enable_tracing:bool) -> IoResult<()> {
        self.start_with_port(port, log_config_or_level,enable_tracing).wait().await
    }
}
