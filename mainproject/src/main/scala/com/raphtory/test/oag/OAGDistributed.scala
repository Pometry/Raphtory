...
object OAGDistributed extends App {
  ...
  new RaphtoryComponent("spout",partitionCount,routerCount,1603,"com.raphtory.spouts.FileSpout")
  new RaphtoryComponent("router",partitionCount,routerCount,1604,"com.raphtory.test.oag.OAGGraphBuilder")
  new RaphtoryComponent("router",partitionCount,routerCount,1605,"com.raphtory.test.oag.OAGGraphBuilder")
  new RaphtoryComponent("router",partitionCount,routerCount,1606,"com.raphtory.test.oag.OAGGraphBuilder")
  new RaphtoryComponent("router",partitionCount,routerCount,1607,"com.raphtory.test.oag.OAGGraphBuilder")
  new RaphtoryComponent("router",partitionCount,routerCount,1608,"com.raphtory.test.oag.OAGGraphBuilder")
  new RaphtoryComponent("router",partitionCount,routerCount,1609,"com.raphtory.test.oag.OAGGraphBuilder")
