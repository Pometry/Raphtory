...
object RaphtoryComponent extends App {
    ...
    new RaphtoryComponent("spout",partitionCount,routerCount,1603,"com.raphtory.test.lotr.LOTRSpout")
    new RaphtoryComponent("router",partitionCount,routerCount,1604,"com.raphtory.test.lotr.LOTRGraphBuilder")
    new RaphtoryComponent("router",partitionCount,routerCount,1605,"com.raphtory.test.lotr.LOTRGraphBuilder")
