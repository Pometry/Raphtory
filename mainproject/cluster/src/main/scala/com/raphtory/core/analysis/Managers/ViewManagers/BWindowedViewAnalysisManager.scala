...
class BWindowedViewAnalysisManager(managerCount:Int,jobID: String, analyser: Analyser, time: Long, windows: Array[Long])
        extends ViewAnalysisManager(managerCount,jobID, analyser, time) {
