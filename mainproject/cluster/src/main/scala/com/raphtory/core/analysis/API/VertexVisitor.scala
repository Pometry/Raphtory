...
class VertexVisitor(v : Vertex, jobID:String, superStep:Int, proxy:LiveLens, timestamp:Long, window:Long)(implicit context : ActorContext, managerCount : ManagerCount) {
