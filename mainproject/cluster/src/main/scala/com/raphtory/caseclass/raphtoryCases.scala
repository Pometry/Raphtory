...
case class VertexAdd(msgTime:Long,srcId:Int) //add a vertex (or add/update a property to an existing vertex)
case class VertexAddWithProperties(msgTime:Long,srcId:Int, properties: Map[String,String])
...
case class EdgeAddWithProperties(msgTime:Long,srcId:Int,dstId:Int, properties: Map[String,String])
