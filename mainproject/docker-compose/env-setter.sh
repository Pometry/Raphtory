...
### OLD - Docker compose only ###
#
REPLICA_ID=1 # TODO Delete whenever watchdog will be ready
...
echo "REPLICA_ID   = $REPLICA_ID" # TODO Delete whenever watchdog will be ready
