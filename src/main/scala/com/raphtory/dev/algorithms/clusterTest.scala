...
object clusterTest extends App {
  ...
  new RaphtoryComponent("builder",1604,builder)
  new RaphtoryComponent("builder",1605,builder)
//  new RaphtoryComponent("builder",1606,builder)
//  new RaphtoryComponent("builder",1607,builder)
//  new RaphtoryComponent("builder",1608,builder)
//  new RaphtoryComponent("builder",1609,builder)
//  new RaphtoryComponent("builder",1610,builder)
//  new RaphtoryComponent("builder",1611,builder)
//  new RaphtoryComponent("builder",1612,builder)
//  new RaphtoryComponent("builder",1613,builder)
