...
object GabDistributed extends App {
  ...
  new RaphtoryComponent("router",1604,"com.raphtory.dev.gab.graphbuilders.GabUserGraphBuilder")
  new RaphtoryComponent("router",1605,"com.raphtory.dev.gab.graphbuilders.GabUserGraphBuilder")
  new RaphtoryComponent("router",1606,"com.raphtory.dev.gab.graphbuilders.GabUserGraphBuilder")
