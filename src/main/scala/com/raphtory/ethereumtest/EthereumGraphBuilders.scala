...
class EthereumTxGraphBuilder() extends GraphBuilder[String] {

  override def parseTuple(data: String): Unit = {
    val tx: EthereumTransaction = EthereumTransaction.apply(data)
