...
# Get file paths
source_dir = "/tmp/taint_output/TaintAlgorithm_1634644678064"
...
for f in files:
    ...
    for line in lines:
        split = line.split(",")
        from_address = split[2]
        to_address = split[1]
        g.add_edge(from_address, to_address)
color_map = []
stop_nodes = set([     "0x001866ae5b3de6caa5a51543fd9fb64f524f5478",
...
for node in g:
    print(node)
    if node == "0xa09871aeadf4994ca12f5c0b6056bbd1d343c029":
...
# print("Drawing...")
# f = plt.figure()
# nx.draw(g, ax=f.add_subplot(111), node_color=color_map)
# f.savefig("graph.png")

nx.nx_agraph.write_dot(g,'/tmp/test.dot')
